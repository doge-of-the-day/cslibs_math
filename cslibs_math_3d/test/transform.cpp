...
TEST(Test_cslibs_math_3d, testTransformInitEye) {
  ...
  cslibs_math_3d::Transform3d t_2 =
      cslibs_math_3d::Transform3d(cslibs_math_3d::Point3d(0.0, 0.0, 0.0));
  ...
  cslibs_math_3d::Transform3d t_3 =
      cslibs_math_3d::Transform3d(0.0, 0.0, 0.0, 0.0);
  ...
  cslibs_math_3d::Transform3d t_4 =
      cslibs_math_3d::Transform3d(cslibs_math_3d::Point3d(0.0, 0.0, 0.0), 0.0);
...
TEST(Test_cslibs_math_3d, testTransformInitTranslation) {
  ...
  cslibs_math_3d::Transform3d t_1 =
      cslibs_math_3d::Transform3d(cslibs_math_3d::Point3d(x, y, z));
  EXPECT_EQ(t_1.roll(), 0.0);
  EXPECT_EQ(t_1.pitch(), 0.0);
  EXPECT_EQ(t_1.yaw(), 0.0);
  EXPECT_EQ(t_1.tx(), x);
  ...
  cslibs_math_3d::Transform3d t_3 =
      cslibs_math_3d::Transform3d(cslibs_math_3d::Point3d(x, y, z), 0.0);
  EXPECT_EQ(t_3.roll(), 0.0);
  EXPECT_EQ(t_3.pitch(), 0.0);
  EXPECT_EQ(t_3.yaw(), 0.0);
  EXPECT_EQ(t_3.tx(), x);
...
TEST(Test_cslibs_math_3d, testTransformInitRotation) {
  ...
  cslibs_math_3d::Transform3d t_0 =
      cslibs_math_3d::Transform3d(0.0, 0.0, 0.0, yaw);
  EXPECT_EQ(t_0.roll(), 0.0);
  EXPECT_EQ(t_0.pitch(), 0.0);
  ...
  cslibs_math_3d::Transform3d t_1 =
      cslibs_math_3d::Transform3d(cslibs_math_3d::Point3d(), yaw);
  EXPECT_EQ(t_1.tx(), 0.0);
  EXPECT_EQ(t_1.ty(), 0.0);
  EXPECT_EQ(t_1.tz(), 0.0);
  EXPECT_EQ(t_1.roll(), 0.0);
  EXPECT_EQ(t_1.pitch(), 0.0);
  EXPECT_TRUE(
      cslibs_math::common::eq(yaw, t_1.yaw(), 1e-6) ||
      cslibs_math::common::eq(std::abs(yaw) + std::abs(t_1.yaw()), M_PI, 1e-6));

  cslibs_math_3d::Transform3d t_2 = cslibs_math_3d::Transform3d(
      cslibs_math_3d::Point3d(), cslibs_math_3d::Quaterniond(roll, pitch, yaw));
  EXPECT_EQ(t_2.tx(), 0.0);
  EXPECT_EQ(t_2.ty(), 0.0);
  EXPECT_EQ(t_2.tz(), 0.0);
  EXPECT_TRUE(cslibs_math::common::eq(roll, t_2.roll(), 1e-6) ||
              cslibs_math::common::eq(std::abs(roll) + std::abs(t_2.roll()),
                                      M_PI, 1e-6));
  EXPECT_TRUE(
      cslibs_math::common::eq(pitch, t_2.pitch(), 1e-6) ||
      cslibs_math::common::eq(std::abs(pitch + t_2.pitch()), M_PI, 1e-6));
  EXPECT_TRUE(
      cslibs_math::common::eq(yaw, t_2.yaw(), 1e-6) ||
...
TEST(Test_cslibs_math_3d, testTransformConstructors) {
  ...
  EXPECT_TRUE(
      cslibs_math::common::eq(yaw, t_0.yaw(), 1e-6) ||
  ...
  cslibs_math_3d::Transform3d t_1 =
      cslibs_math_3d::Transform3d(cslibs_math_3d::Point3d(x, y, z), yaw);
  EXPECT_TRUE(
      cslibs_math::common::eq(yaw, t_1.yaw(), 1e-6) ||
      cslibs_math::common::eq(std::abs(yaw) + std::abs(t_1.yaw()), M_PI, 1e-6));
  EXPECT_EQ(t_1.tx(), x);
...
TEST(Test_cslibs_math_3d, testTransformSetFrom) {
  ...
  EXPECT_TRUE(cslibs_math::common::eq(roll, t_0.roll(), 1e-6) ||
              cslibs_math::common::eq(std::abs(roll) + std::abs(t_0.roll()),
                                      M_PI, 1e-6));
  EXPECT_TRUE(
      cslibs_math::common::eq(pitch, t_0.pitch(), 1e-6) ||
  ...
  EXPECT_TRUE(cslibs_math::common::eq(roll, t_1.roll(), 1e-6) ||
              cslibs_math::common::eq(std::abs(roll) + std::abs(t_1.roll()),
                                      M_PI, 1e-6));
  EXPECT_TRUE(
      cslibs_math::common::eq(pitch, t_1.pitch(), 1e-6) ||
...
TEST(Test_cslibs_math_3d, testTransformSetRPY) {
  ...
  EXPECT_TRUE(cslibs_math::common::eq(yaw0, t_0.yaw(), 1e-6) ||
              cslibs_math::common::eq(std::abs(yaw0) + std::abs(t_0.yaw()),
                                      M_PI, 1e-6));
  ...
  EXPECT_TRUE(cslibs_math::common::eq(yaw1, t_0.yaw(), 1e-6) ||
              cslibs_math::common::eq(std::abs(yaw1) + std::abs(t_0.yaw()),
                                      M_PI, 1e-6));
}
...
TEST(Test_cslibs_math_3d, testTransformRotation) {
  ...
  tf::Transform t_0_tf =
      tf::Transform(tf::createQuaternionFromRPY(roll_0, pitch_0, yaw_0),
  ...
  tf::Matrix3x3(t_1_tf.getRotation())
      .getRPY(t_1_tf_roll, t_1_tf_pitch, t_1_tf_yaw);

  EXPECT_TRUE(cslibs_math::common::eq(t_1_tf_roll, t_1.roll(), 1e-6) ||
              cslibs_math::common::eq(
                  std::abs(t_1_tf_roll) + std::abs(t_1.roll()), M_PI, 1e-6));
  EXPECT_TRUE(cslibs_math::common::eq(t_1_tf_pitch, t_1.pitch(), 1e-6) ||
              cslibs_math::common::eq(std::abs(t_1_tf_pitch + t_1.pitch()),
                                      M_PI, 1e-6));
  EXPECT_TRUE(cslibs_math::common::eq(t_1_tf_yaw, t_1.yaw(), 1e-6) ||
              cslibs_math::common::eq(
                  std::abs(t_1_tf_yaw) + std::abs(t_0.yaw()), M_PI, 1e-6));
}
...
TEST(Test_cslibs_math_3d, testTransformFull) {
  ...
  cslibs_math_3d::Transform3d t_0(
      cslibs_math_3d::Vector3d(x_0, y_0, z_0),
      cslibs_math_3d::Quaterniond(roll_0, pitch_0, yaw_0));
  ...
  cslibs_math_3d::Transform3d t_1(
      cslibs_math_3d::Vector3d(x_1, y_1, z_1),
      cslibs_math_3d::Quaterniond(roll_1, pitch_1, yaw_1));
  tf::Transform t_1_tf(tf::createQuaternionFromRPY(roll_1, pitch_1, yaw_1),
                       tf::Vector3(x_1, y_1, z_1));
  ...
  EXPECT_TRUE(cslibs_math::common::eq(roll_1, t_1.roll(), 1e-6) ||
              cslibs_math::common::eq(std::abs(roll_1) + std::abs(t_1.roll()),
                                      M_PI, 1e-6));
  EXPECT_TRUE(
      cslibs_math::common::eq(pitch_1, t_1.pitch(), 1e-6) ||
      cslibs_math::common::eq(std::abs(pitch_1 + t_1.pitch()), M_PI, 1e-6));
  EXPECT_TRUE(cslibs_math::common::eq(yaw_1, t_1.yaw(), 1e-6) ||
              cslibs_math::common::eq(std::abs(yaw_1) + std::abs(t_1.yaw()),
                                      M_PI, 1e-6));
  ...
  EXPECT_TRUE(cslibs_math::common::eq(t_1_tf_yaw, t_1.yaw(), 1e-6) ||
              cslibs_math::common::eq(
                  std::abs(t_1_tf_yaw) + std::abs(t_1.yaw()), M_PI, 1e-6));
...
TEST(Test_cslibs_math_3d, testTransformInterpolation) {
  ...
  tf::Matrix3x3(t_0_tf.getRotation())
      .getRPY(t_0_tf_roll, t_0_tf_pitch, t_0_tf_yaw);
  double t_1_tf_roll, t_1_tf_pitch, t_1_tf_yaw;
  tf::Matrix3x3(t_1_tf.getRotation())
      .getRPY(t_1_tf_roll, t_1_tf_pitch, t_1_tf_yaw);
  ...
  EXPECT_TRUE(cslibs_math::common::eq(t_0_tf_roll, t_0.roll(), 1e-6) ||
              cslibs_math::common::eq(
                  std::abs(t_0_tf_roll) + std::abs(t_0.roll()), M_PI, 1e-6));
  EXPECT_TRUE(cslibs_math::common::eq(t_0_tf_pitch, t_0.pitch(), 1e-6) ||
              cslibs_math::common::eq(std::abs(t_0_tf_pitch + t_0.pitch()),
                                      M_PI, 1e-6));
  EXPECT_TRUE(cslibs_math::common::eq(t_0_tf_yaw, t_0.yaw(), 1e-6) ||
              cslibs_math::common::eq(
                  std::abs(t_0_tf_yaw) + std::abs(t_0.yaw()), M_PI, 1e-6));
  ...
  tf::Transform t_r_tf;
  t_r_tf.getOrigin().setInterpolate3(t_0_tf.getOrigin(), t_1_tf.getOrigin(),
                                     0.66);
  t_r_tf.setRotation(
      tf::slerp(t_0_tf.getRotation(), t_1_tf.getRotation(), 0.66));

  double t_r_tf_roll, t_r_tf_pitch, t_r_tf_yaw;
  tf::Matrix3x3(t_r_tf.getRotation())
      .getRPY(t_r_tf_roll, t_r_tf_pitch, t_r_tf_yaw);
  ...
  EXPECT_TRUE(cslibs_math::common::eq(t_r_tf_roll, t_r.roll(), 1e-6) ||
              cslibs_math::common::eq(
                  std::abs(t_r_tf_roll) + std::abs(t_r.roll()), M_PI, 1e-6));
  EXPECT_TRUE(cslibs_math::common::eq(t_r_tf_pitch, t_r.pitch(), 1e-6) ||
              cslibs_math::common::eq(std::abs(t_r_tf_pitch + t_r.pitch()),
                                      M_PI, 1e-6));
  EXPECT_TRUE(cslibs_math::common::eq(t_r_tf_yaw, t_r.yaw(), 1e-6) ||
              cslibs_math::common::eq(
                  std::abs(t_r_tf_yaw) + std::abs(t_r.yaw()), M_PI, 1e-6));
}
...
TEST(Test_cslibs_math_3d, testTransformAssignment) {
  auto test_eq = [](const cslibs_math_3d::Transform3d &ta,
                    const cslibs_math_3d::Transform3d &tb) {
    EXPECT_EQ(ta.tx(), tb.tx());
    EXPECT_EQ(ta.ty(), tb.ty());
  ...
  cslibs_math_3d::Transform3d assigned;
  for (std::size_t i = 0; i < ITERATIONS; ++i) {
    auto t = cslibs_math_3d::Transform3d::random();
    assigned = t;
    test_eq(assigned, t);
  }
  for (std::size_t i = 0; i < ITERATIONS; ++i) {
