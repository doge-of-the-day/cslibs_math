...
TEST(Test_cslibs_math_2d, testTransformInitEye) {
  ...
  cslibs_math_2d::Transform2d t_2 =
      cslibs_math_2d::Transform2d(cslibs_math_2d::Point2d(0.0, 0.0));
  ...
  cslibs_math_2d::Transform2d t_4 =
      cslibs_math_2d::Transform2d(cslibs_math_2d::Point2d(0.0, 0.0), 0.0);
...
TEST(Test_cslibs_math_2d, testTransformInitTranslation) {
  ...
  cslibs_math_2d::Transform2d t_1 =
      cslibs_math_2d::Transform2d(cslibs_math_2d::Point2d(x, y));
  EXPECT_EQ(t_1.yaw(), 0.0);
  EXPECT_EQ(t_1.tx(), x);
  EXPECT_EQ(t_1.ty(), y);
  EXPECT_EQ(t_1.sin(), 0.0);
  ...
  cslibs_math_2d::Transform2d t_3 =
      cslibs_math_2d::Transform2d(cslibs_math_2d::Point2d(x, y), 0.0);
  EXPECT_EQ(t_3.yaw(), 0.0);
  EXPECT_EQ(t_3.tx(), x);
  EXPECT_EQ(t_3.ty(), y);
  EXPECT_EQ(t_3.sin(), 0.0);
...
TEST(Test_cslibs_math_2d, testTransformInitRotation) {
  ...
  cslibs_math_2d::Transform2d t_1 =
      cslibs_math_2d::Transform2d(cslibs_math_2d::Point2d(0.0, 0.0), yaw);
...
TEST(Test_cslibs_math_2d, testTransformConstructors) {
  ...
  cslibs_math_2d::Transform2d t_1 =
      cslibs_math_2d::Transform2d(cslibs_math_2d::Point2d(x, y), yaw);
  EXPECT_EQ(t_1.yaw(), yaw);
  EXPECT_EQ(t_1.tx(), x);
  EXPECT_EQ(t_1.ty(), y);
  EXPECT_EQ(t_1.sin(), sin);
...
TEST(Test_cslibs_math_2d, testTransformInverse) {
  ...
  for (std::size_t i = 0; i < ITERATIONS; ++i) {
    ...
    EXPECT_NEAR(t_1_inverse.yaw(), tf::getYaw(tf_1_inverse.getRotation()),
                1e-5);
  }
}
