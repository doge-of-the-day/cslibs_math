...
TEST(Test_cslibs_math, testDistributionEigenVectors) {
  auto equals = [](const Eigen::Vector2f &a, const Eigen::Vector2f &b,
                   const float eps) {
...
TEST(Test_cslibs_math, testDistributionCopy) {
  ...
  const bool success_a =
      distribution_a.getEigenValuesVectors(eigen_values_a, eigen_vectors_a);
  const bool success_b =
      distribution_b.getEigenValuesVectors(eigen_values_b, eigen_vectors_b);
...
TEST(Test_cslibs_math, testWeightedDistributionAddition) {
  testWeightedDistributionAddition<cs::WeightedDistribution<float, 2>>(
      test_distribution_200);
  testWeightedDistributionAddition<cs::WeightedDistribution<float, 2>>(
      test_distribution_500);
  testWeightedDistributionAddition<cs::WeightedDistribution<float, 2>>(
      test_distribution_5000);
  testWeightedDistributionAddition<cs::StableWeightedDistribution<float, 2>>(
      test_distribution_200);
  testWeightedDistributionAddition<cs::StableWeightedDistribution<float, 2>>(
      test_distribution_500);
  testWeightedDistributionAddition<cs::StableWeightedDistribution<float, 2>>(
  ...
  testWeightedDistributionScale<cs::WeightedDistribution<float, 2>>(
      test_distribution_200);
  testWeightedDistributionScale<cs::WeightedDistribution<float, 2>>(
      test_distribution_500);
  testWeightedDistributionScale<cs::WeightedDistribution<float, 2>>(
      test_distribution_5000);
  testWeightedDistributionScale<cs::StableWeightedDistribution<float, 2>>(
      test_distribution_200);
  testWeightedDistributionScale<cs::StableWeightedDistribution<float, 2>>(
      test_distribution_500);
  testWeightedDistributionScale<cs::StableWeightedDistribution<float, 2>>(
