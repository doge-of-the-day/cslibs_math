...
std::array<_Tp, _Nm> operator-(const std::array<_Tp, _Nm> &__one,
  ...
  for (std::size_t i = 0; i < _Nm; ++i) arr[i] = __one[i] - __two[i];
  return arr;
}

template <typename _Tp, std::size_t _Nm>
std::array<_Tp, _Nm> operator-(const std::array<_Tp, _Nm> &__one, const _Tp s) {
  std::array<_Tp, _Nm> arr;
  for (std::size_t i = 0; i < _Nm; ++i) arr[i] = __one[i] - s;
  return arr;
}
...
std::array<_Tp, _Nm> operator*(const std::array<_Tp, _Nm> &__one, const _Tp s) {
  ...
  for (std::size_t i = 0; i < _Nm; ++i) arr[i] *= s;
  return arr;
}
...
std::array<_Tp, _Nm> min(const std::array<_Tp, _Nm> &__one,
                         const std::array<_Tp, _Nm> &__two) {
  std::array<_Tp, _Nm> arr;
  for (std::size_t i = 0; i < _Nm; ++i) arr[i] = std::min(__one[i], __two[i]);
  return arr;
}
...
std::array<_Tp, _Nm> max(const std::array<_Tp, _Nm> &__one,
                         const std::array<_Tp, _Nm> &__two) {
  std::array<_Tp, _Nm> arr;
  for (std::size_t i = 0; i < _Nm; ++i) arr[i] = std::max(__one[i], __two[i]);
  return arr;
}
...
std::array<_Tp, _Nm> abs(const std::array<_Tp, _Nm> &__one) {
  std::array<_Tp, _Nm> arr;
  for (std::size_t i = 0; i < _Nm; ++i) arr[i] = std::abs(__one[i]);
  return arr;
}
...
std::array<int, _Nm> compare(const std::array<_Tp, _Nm> &__one,
  ...
  for (std::size_t i = 0; i < _Nm; ++i) arr[i] = __one[i] < __two[i] ? 1 : -1;
  return arr;
}

template <typename _Tp, std::size_t _Nm>
std::array<int, _Nm> compare(const std::array<_Tp, _Nm> &__one, const _Tp s) {
  std::array<int, _Nm> arr;
  for (std::size_t i = 0; i < _Nm; ++i) arr[i] = __one[i] < s ? 1 : -1;
  return arr;
}
...
std::array<_Tp, _Nm> ceil(const std::array<_Tp, _Nm> &__one) {
  std::array<_Tp, _Nm> arr = __one;
  for (std::size_t i = 0; i < _Nm; ++i) arr[i] = std::ceil(__one[i]);
  return arr;
}
...
std::array<_Tp, _Nm> floor(const std::array<_Tp, _Nm> &__one) {
  std::array<_Tp, _Nm> arr = __one;
  for (std::size_t i = 0; i < _Nm; ++i) arr[i] = std::floor(__one[i]);
  return arr;
}
...
std::array<_T, _Nm> cast(const std::array<_Tp, _Nm> &__one) {
  ...
  for (std::size_t i = 0; i < _Nm; ++i) arr[i] = static_cast<_T>(__one[i]);
  return arr;
}
}  // namespace common
}  // namespace cslibs_math
